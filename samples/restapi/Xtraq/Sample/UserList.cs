...
public static class UserListExtensions
{
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<UserListResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
	...
	public static Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<UserListResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
...
public static class UserListProcedure
{
	...
	public static async Task StreamResultResultSet1Async(DbConnection connection, Func<UserListResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		async Task StreamCoreAsync(DbDataReader reader, CancellationToken ct)
		{
            ...
            int o8=ReaderUtil.TryGetOrdinal(r, "SearchName");
			while (await reader.ReadAsync(ct).ConfigureAwait(false))
			{
				var row = new UserListResultSet1Result(o0 < 0 ? default(int) : r.GetInt32(o0), o1 < 0 ? null : (r.IsDBNull(o1) ? null : r.GetString(o1)), o2 < 0 ? string.Empty : (r.IsDBNull(o2) ? string.Empty : r.GetString(o2)), o3 < 0 ? null : (r.IsDBNull(o3) ? null : r.GetString(o3)), o4 < 0 ? default(bool) : r.GetBoolean(o4), o5 < 0 ? string.Empty : (r.IsDBNull(o5) ? string.Empty : r.GetString(o5)), o6 < 0 ? default(DateTime) : r.GetDateTime(o6), o7 < 0 ? null : (r.IsDBNull(o7) ? null : (DateTime?)r.GetDateTime(o7)), o8 < 0 ? string.Empty : (r.IsDBNull(o8) ? string.Empty : r.GetString(o8)));
	...
	public static Task StreamResultResultSet1Async(DbConnection connection, Func<UserListResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
