...
public static class UserDetailsWithOrdersRouteHandlerBuilderExtensions
{
    public static RouteHandlerBuilder WithUserDetailsWithOrdersProcedure(this RouteHandlerBuilder builder)
    {
        ...
        return builder.WithProcedure<UserDetailsWithOrdersInput, UserDetailsWithOrdersResult>(
            static pipeline => pipeline.WithExecutor(
                static (dbContext, input cancellationToken) => new ValueTask<UserDetailsWithOrdersResult>(
                    UserDetailsWithOrdersExtensions.UserDetailsWithOrdersAsync(dbContext, input, cancellationToken))));
    }
}
#endif
