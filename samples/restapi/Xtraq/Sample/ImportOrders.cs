...
public static class ImportOrdersExtensions
{
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<ImportOrdersResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
	...
	public static Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<ImportOrdersResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
...
public static class ImportOrdersProcedure
{
	...
	public static async Task StreamResultResultSet1Async(DbConnection connection, Func<ImportOrdersResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		{
            int o0=ReaderUtil.TryGetOrdinal(r, "ImportedOrders");
			while (await reader.ReadAsync(ct).ConfigureAwait(false))
			{
				var row = new ImportOrdersResultSet1Result(o0 < 0 ? default(int) : r.GetInt32(o0));
	...
	public static Task StreamResultResultSet1Async(DbConnection connection, Func<ImportOrdersResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
