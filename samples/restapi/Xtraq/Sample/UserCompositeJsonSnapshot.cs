...
public static class UserCompositeJsonSnapshotRouteHandlerBuilderExtensions
{
    public static RouteHandlerBuilder WithUserCompositeJsonSnapshotProcedure(this RouteHandlerBuilder builder)
    {
        ...
        return builder.WithProcedure<UserCompositeJsonSnapshotInput, UserCompositeJsonSnapshotResult>(
            static pipeline => pipeline.WithExecutor(
                static (dbContext, input cancellationToken) => new ValueTask<UserCompositeJsonSnapshotResult>(
                    UserCompositeJsonSnapshotExtensions.UserCompositeJsonSnapshotAsync(dbContext, input, cancellationToken))));
    }
}
#endif
