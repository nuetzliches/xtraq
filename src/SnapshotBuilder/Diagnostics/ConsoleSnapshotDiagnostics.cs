...
internal sealed class ConsoleSnapshotDiagnostics : ISnapshotDiagnostics
{
    ...
    {
        var explicitPath = Environment.GetEnvironmentVariable("XTRAQ_SNAPSHOT_SUMMARY_PATH");
        var summaryFlag = Environment.GetEnvironmentVariable("XTRAQ_SNAPSHOT_SUMMARY");
