...
public static class UserListRouteHandlerBuilderExtensions
{
    public static RouteHandlerBuilder WithUserListProcedure(this RouteHandlerBuilder builder)
    {
        ...
        return builder.WithProcedure<UserListInput, UserListResult>(
            static pipeline => pipeline.WithExecutor(
                static (dbContext, input cancellationToken) => new ValueTask<UserListResult>(
                    UserListExtensions.UserListAsync(dbContext, input, cancellationToken))));
    }
}
#endif
