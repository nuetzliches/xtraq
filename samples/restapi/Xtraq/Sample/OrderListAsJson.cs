...
public static class OrderListAsJsonExtensions
{
	public static async Task<OrderListAsJsonResult> OrderListAsJsonAsync(this IXtraqDbContext db, OrderListAsJsonInput input, CancellationToken cancellationToken = default)
	{
		...
		return await OrderListAsJsonProcedure.ExecuteAsync(conn, input, cancellationToken).ConfigureAwait(false);
	}
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, OrderListAsJsonInput input, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		await OrderListAsJsonProcedure.StreamResultResultSet1Async(connection, input, onRowAsync, cancellationToken).ConfigureAwait(false);
	}
...
public static class OrderListAsJsonProcedure
{
	...
	{
		return ProcedureExecutor.ExecuteAsync<OrderListAsJsonResult>(connection, OrderListAsJsonPlan.Instance, input, cancellationToken);
	}

	/// <summary>Streams result set <c>ResultSet1</c> using the supplied row callback.</summary>
	public static async Task StreamResultResultSet1Async(DbConnection connection, OrderListAsJsonInput input, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		await ProcedureExecutor.StreamResultSetAsync(connection, OrderListAsJsonPlan.Instance, 0, StreamCoreAsync, input, cancellationToken).ConfigureAwait(false);
	}
