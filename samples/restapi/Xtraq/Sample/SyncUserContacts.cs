...
public static class SyncUserContactsRouteHandlerBuilderExtensions
{
    public static RouteHandlerBuilder WithSyncUserContactsProcedure(this RouteHandlerBuilder builder)
    {
        ...
        return builder.WithProcedure<SyncUserContactsInput, SyncUserContactsResult>(
            static pipeline => pipeline.WithExecutor(
                static (dbContext, input cancellationToken) => new ValueTask<SyncUserContactsResult>(
                    SyncUserContactsExtensions.SyncUserContactsAsync(dbContext, input, cancellationToken))));
    }
}
#endif
