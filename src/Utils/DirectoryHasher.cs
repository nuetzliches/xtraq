...
internal static class DirectoryHasher
{
    ...
    internal sealed record Manifest(string Root, string Algorithm, IReadOnlyList<FileHash> Files, string AggregateSha256);

    internal static Manifest HashDirectory(string root, Func<string, bool>? fileFilter = null)
    {
    ...
    internal static void WriteManifest(Manifest manifest, string outputFile)
    {
