...
internal static class StoredProcedureQueries
{
    public static Task<List<StoredProcedure>> StoredProcedureListAsync(this DbContext context, string schemaList, CancellationToken cancellationToken)
    {
        ...
        return context.ListAsync<StoredProcedure>(
            queryString,
            new List<SqlParameter>(),
            cancellationToken,
            telemetryOperation: "StoredProcedureQueries.StoredProcedureList",
    ...
    public static Task<List<StoredProcedureDependencyEdge>> StoredProcedureDependencyListAsync(this DbContext context, CancellationToken cancellationToken)
    {
        ...
        return context.ListAsync<StoredProcedureDependencyEdge>(
            queryString,
            new List<SqlParameter>(),
            cancellationToken,
            telemetryOperation: "StoredProcedureQueries.Dependencies",
    ...
    public static async Task<StoredProcedureDefinition?> StoredProcedureDefinitionAsync(this DbContext context, string schemaName, string name, CancellationToken cancellationToken)
    {
        ...
        return await context.SingleAsync<StoredProcedureDefinition>(
            queryString,
            parameters,
            cancellationToken,
            telemetryOperation: "StoredProcedureQueries.Definition",
            telemetryCategory: "Collector.StoredProcedures").ConfigureAwait(false);
    }
    ...
    public static async Task<List<StoredProcedureOutput>?> StoredProcedureOutputListAsync(this DbContext context, string schemaName, string name, CancellationToken cancellationToken)
    {
        ...
        return await context.ListAsync<StoredProcedureOutput>(
            queryString,
            parameters,
            cancellationToken,
            telemetryOperation: "StoredProcedureQueries.OutputColumns",
            telemetryCategory: "Collector.StoredProcedures").ConfigureAwait(false);
    }
    ...
    public static async Task<List<StoredProcedureInput>?> StoredProcedureInputListAsync(this DbContext context, string schemaName, string name, CancellationToken cancellationToken)
    {
        ...
        return await context.ListAsync<StoredProcedureInput>(
            queryString,
            parameters,
            cancellationToken,
            telemetryOperation: "StoredProcedureQueries.InputParameters",
            telemetryCategory: "Collector.StoredProcedures").ConfigureAwait(false);
    }
    ...
    public static async Task<string?> StoredProcedureContentAsync(this DbContext context, string schemaName, string name, CancellationToken cancellationToken)
    {
        ...
        var content = await context.SingleAsync<StoredProcedureContent>(
            queryString,
            parameters,
            cancellationToken,
            telemetryOperation: "StoredProcedureQueries.DefinitionContent",
            telemetryCategory: "Collector.StoredProcedures").ConfigureAwait(false);
