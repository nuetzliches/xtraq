...
scripts=(
  ...
  "/sql/tables/TestOrderNotes.sql"
  "/sql/tables/TestFooOrderTags.sql"
  "/sql/procedures/UserList.sql"
  "/sql/procedures/UserFind.sql"
  "/sql/procedures/UserPreferredContactApply.sql"
  ...
  "/sql/procedures/UserOrderSubselectDiagnostics.sql"
  "/sql/procedures/UserOrderJoinDiagnostics.sql"
  "/sql/procedures/UserOrderInsights.sql"
