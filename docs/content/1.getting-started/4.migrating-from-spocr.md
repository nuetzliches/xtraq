...
- Required features or optimisations (for example table-type trimming, execution policies, DI-scoped transaction orchestrator) have landed in your branch or are covered by feature flags.
