...
/// </summary>
public sealed record class OrderListAsJsonRequest
{
...
internal static class OrderListAsJsonRequestMapper
{
    ...
    {
        request ??= new OrderListAsJsonRequest();
    ...
    public static ValueTask<OrderListAsJsonInput> ToInputAsync(OrderListAsJsonRequest? request, IXtraqDbContext dbContext, CancellationToken cancellationToken = default)
    {
...
{
    public static async Task<OrderListAsJsonResult> OrderListAsJsonAsync(this IXtraqDbContext db, OrderListAsJsonRequest request, CancellationToken cancellationToken = default)
    {
        var bindingProvider = db as IXtraqParameterBindingProvider;
        var input = await OrderListAsJsonRequestMapper.ToInputAsync(request, bindingProvider, cancellationToken).ConfigureAwait(false);
        return await OrderListAsJsonAsync(db, input, cancellationToken).ConfigureAwait(false);
    }
	...
	public static async Task<OrderListAsJsonResult> OrderListAsJsonAsync(this IXtraqDbContext db, OrderListAsJsonInput input, CancellationToken cancellationToken = default)
	{
		...
		return await OrderListAsJsonProcedure.ExecuteAsync(db as IXtraqProcedureInterceptorProvider, db as IXtraqParameterBindingProvider, conn, input, cancellationToken).ConfigureAwait(false);
	}
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, OrderListAsJsonInput input, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		await OrderListAsJsonProcedure.StreamResultResultSet1Async(db as IXtraqProcedureInterceptorProvider, db as IXtraqParameterBindingProvider, connection, input, onRowAsync, cancellationToken).ConfigureAwait(false);
	}
    ...
    public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, OrderListAsJsonRequest request, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(db);
        ArgumentNullException.ThrowIfNull(onRowAsync);
        var bindingProvider = db as IXtraqParameterBindingProvider;
    ...
    /// <summary>Streams result set <c>ResultSet1</c> using a request DTO; request is mapped and hydrated before streaming.</summary>
    public static Task StreamResultResultSet1Async(this IXtraqDbContext db, OrderListAsJsonRequest request, Func<OrderListAsJsonResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(onRowAsync);
...
public static class OrderListAsJsonRouteHandlerBuilderExtensions
{
    public static RouteHandlerBuilder WithOrderListAsJsonProcedure(this RouteHandlerBuilder builder)
    {
        ...
        return builder.WithProcedure<OrderListAsJsonRequest, OrderListAsJsonResult>(
            static pipeline => pipeline.WithExecutor(
                static async ValueTask<OrderListAsJsonResult> (dbContext, request, cancellationToken) =>
                {
                    var bindingProvider = dbContext as IXtraqParameterBindingProvider;
                    var input = await OrderListAsJsonRequestMapper.ToInputAsync(request, bindingProvider, cancellationToken).ConfigureAwait(false);
                    return await OrderListAsJsonExtensions.OrderListAsJsonAsync(dbContext, input, cancellationToken).ConfigureAwait(false);
                }));
    }
}
#endif
...
public static class OrderListAsJsonProcedure
{
	...
	public static Task<OrderListAsJsonResult> ExecuteAsync(IXtraqProcedureInterceptorProvider? interceptorProvider, IXtraqParameterBindingProvider? bindingProvider, DbConnection connection, OrderListAsJsonInput input, CancellationToken cancellationToken = default)
	{
		return ProcedureExecutor.ExecuteAsync<OrderListAsJsonResult>(interceptorProvider, bindingProvider, connection, OrderListAsJsonPlan.Instance, input, cancellationToken);
	}
	...
	public static Task StreamResultResultSet1Async(IXtraqProcedureInterceptorProvider? interceptorProvider, DbConnection connection, OrderListAsJsonInput input, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
		=> StreamResultResultSet1Async(interceptorProvider, null, connection, input, onRowAsync, cancellationToken);

	public static async Task StreamResultResultSet1Async(IXtraqProcedureInterceptorProvider? interceptorProvider, IXtraqParameterBindingProvider? bindingProvider, DbConnection connection, OrderListAsJsonInput input, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		await ProcedureExecutor.StreamResultSetAsync(interceptorProvider, bindingProvider, connection, OrderListAsJsonPlan.Instance, 0, StreamCoreAsync, input, cancellationToken).ConfigureAwait(false);
	}
