...
public static class OrderListAsJsonExtensions
{
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
	...
	public static Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<OrderListAsJsonResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
...
public static class OrderListAsJsonProcedure
{
	...
	public static async Task StreamResultResultSet1Async(DbConnection connection, Func<OrderListAsJsonResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		{
            int o0=ReaderUtil.TryGetOrdinal(r, "OrdersJson");
			while (await reader.ReadAsync(ct).ConfigureAwait(false))
			{
				var row = new OrderListAsJsonResultSet1Result(o0 < 0 ? string.Empty : (r.IsDBNull(o0) ? string.Empty : r.GetString(o0)));
	...
	public static Task StreamResultResultSet1Async(DbConnection connection, Func<OrderListAsJsonResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
