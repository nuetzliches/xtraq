...
/// <summary>
/// Provides helper routines for generating stable names for stored procedure result sets.
/// </summary>
public static class ResultSetNaming
{
    /// <summary>
    /// Derives a unique result set identifier using field descriptors and previously generated names.
    /// </summary>
    /// <param name="index">Zero-based index of the result set within the procedure.</param>
    /// <param name="fields">Projected fields describing the result set.</param>
    /// <param name="existing">Set of result set names already assigned in the current scope.</param>
    /// <returns>A sanitized, unique name for the result set.</returns>
