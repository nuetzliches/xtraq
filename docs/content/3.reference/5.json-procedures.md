...
> For endpoint integration patterns and DTO mapping guidance (applicable to JSON and tabular procedures alike), see [Minimal APIs & DTO Mapping](/reference/api-integration).
