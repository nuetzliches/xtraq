...
const starColor = computed(() => props.color)
</script>
...
<template>
  <div class="absolute pointer-events-none z-[-1] inset-y-0 inset-x-5 sm:inset-x-7 lg:inset-x-9 overflow-hidden">
    <svg class="absolute inset-0 pointer-events-none"
      ...
      <g opacity="0.5">
        <mask id="path-1-inside-1_846_160841"
              fill="white">
      ...
      <defs>
        <radialGradient id="paint0_radial_846_160841"
                        cx="0"
                        cy="0"
                        r="1"
        ...
        <linearGradient id="paint1_linear_846_160841"
                        x1="10.9784"
                        y1="91"
                        x2="1017"
                        y2="90.502"
    ...
    <div class="stars size-full absolute inset-x-0 top-0">
      <div v-for="(layer, index) in starLayers"
           :key="index"
           class="star-layer"
           :style="{
        ...
        <div v-for="(star, starIndex) in layer.stars"
             :key="starIndex"
