...
using Xtraq.Utils;
using SnapshotProcedureCacheEntry = Xtraq.SnapshotBuilder.Models.ProcedureCacheEntry;
using SnapshotProcedureDependency = Xtraq.SnapshotBuilder.Models.ProcedureDependency;

namespace Xtraq.SnapshotBuilder.Cache;

/// <summary>
/// Persists procedure snapshot fingerprints under .xtraq/cache/procedures.json to enable fast reuse decisions.
/// </summary>
