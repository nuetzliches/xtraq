...
#if XTRAQ_API_MODE_MINIMAL
internal static class UserDetailsWithOrdersRequestMapper
{
    public static async ValueTask<UserDetailsWithOrdersInput> ToInputAsync(UserDetailsWithOrdersRequest? request, IXtraqParameterBindingProvider? bindingProvider, CancellationToken cancellationToken = default)
    {
    ...
    public static ValueTask<UserDetailsWithOrdersInput> ToInputAsync(UserDetailsWithOrdersRequest? request, IXtraqDbContext dbContext, CancellationToken cancellationToken = default)
    {
...
{
#if XTRAQ_API_MODE_MINIMAL
    public static async Task<UserDetailsWithOrdersResult> UserDetailsWithOrdersAsync(this IXtraqDbContext db, UserDetailsWithOrdersRequest request, CancellationToken cancellationToken = default)
    {
        var bindingProvider = db as IXtraqParameterBindingProvider;
        var input = await UserDetailsWithOrdersRequestMapper.ToInputAsync(request, bindingProvider, cancellationToken).ConfigureAwait(false);
        return await UserDetailsWithOrdersAsync(db, input, cancellationToken).ConfigureAwait(false);
    }
#endif
	...
	public static async Task<UserDetailsWithOrdersResult> UserDetailsWithOrdersAsync(this IXtraqDbContext db, UserDetailsWithOrdersInput input, CancellationToken cancellationToken = default)
	{
		...
		return await UserDetailsWithOrdersProcedure.ExecuteAsync(db as IXtraqProcedureInterceptorProvider, db as IXtraqParameterBindingProvider, conn, input, cancellationToken).ConfigureAwait(false);
	}
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, UserDetailsWithOrdersInput input, Func<UserDetailsWithOrdersResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		await UserDetailsWithOrdersProcedure.StreamResultResultSet1Async(db as IXtraqProcedureInterceptorProvider, db as IXtraqParameterBindingProvider, connection, input, onRowAsync, cancellationToken).ConfigureAwait(false);
	}
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, UserDetailsWithOrdersRequest request, Func<UserDetailsWithOrdersResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(db);
		ArgumentNullException.ThrowIfNull(onRowAsync);
		var bindingProvider = db as IXtraqParameterBindingProvider;
	...
	/// <summary>Streams result set <c>ResultSet1</c> using a request DTO; request is mapped and hydrated before streaming.</summary>
	public static Task StreamResultResultSet1Async(this IXtraqDbContext db, UserDetailsWithOrdersRequest request, Func<UserDetailsWithOrdersResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
	...
	public static async Task StreamResultResultSet2Async(this IXtraqDbContext db, UserDetailsWithOrdersInput input, Func<UserDetailsWithOrdersResultSet2Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		ArgumentNullException.ThrowIfNull(onRowAsync);
		await using var connection = await db.OpenConnectionAsync(cancellationToken).ConfigureAwait(false);
		await UserDetailsWithOrdersProcedure.StreamResultResultSet2Async(db as IXtraqProcedureInterceptorProvider, db as IXtraqParameterBindingProvider, connection, input, onRowAsync, cancellationToken).ConfigureAwait(false);
	}
	...
	public static async Task StreamResultResultSet2Async(this IXtraqDbContext db, UserDetailsWithOrdersRequest request, Func<UserDetailsWithOrdersResultSet2Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(db);
		ArgumentNullException.ThrowIfNull(onRowAsync);
		var bindingProvider = db as IXtraqParameterBindingProvider;
	...
	/// <summary>Streams result set <c>ResultSet2</c> using a request DTO; request is mapped and hydrated before streaming.</summary>
	public static Task StreamResultResultSet2Async(this IXtraqDbContext db, UserDetailsWithOrdersRequest request, Func<UserDetailsWithOrdersResultSet2Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
...
#if XTRAQ_API_MODE_MINIMAL
/// <summary>Minimal API extension for '[sample].[UserDetailsWithOrders]'.</summary>
public static class UserDetailsWithOrdersRouteHandlerBuilderExtensions
{
    public static RouteHandlerBuilder WithUserDetailsWithOrdersProcedure(this RouteHandlerBuilder builder)
    {
        ArgumentNullException.ThrowIfNull(builder);

        return builder.WithProcedure<UserDetailsWithOrdersRequest, UserDetailsWithOrdersResult>(
            static pipeline => pipeline.WithExecutor(
                static async ValueTask<UserDetailsWithOrdersResult> (dbContext, request, cancellationToken) =>
                {
                    var bindingProvider = dbContext as IXtraqParameterBindingProvider;
                    var input = await UserDetailsWithOrdersRequestMapper.ToInputAsync(request, bindingProvider, cancellationToken).ConfigureAwait(false);
                    return await UserDetailsWithOrdersExtensions.UserDetailsWithOrdersAsync(dbContext, input, cancellationToken).ConfigureAwait(false);
                }));
    }
}
#endif
...
public static class UserDetailsWithOrdersProcedure
{
	...
	public static Task<UserDetailsWithOrdersResult> ExecuteAsync(IXtraqProcedureInterceptorProvider? interceptorProvider, IXtraqParameterBindingProvider? bindingProvider, DbConnection connection, UserDetailsWithOrdersInput input, CancellationToken cancellationToken = default)
	{
		return ProcedureExecutor.ExecuteAsync<UserDetailsWithOrdersResult>(interceptorProvider, bindingProvider, connection, UserDetailsWithOrdersPlan.Instance, input, cancellationToken);
	}
	...
	public static Task StreamResultResultSet1Async(IXtraqProcedureInterceptorProvider? interceptorProvider, DbConnection connection, UserDetailsWithOrdersInput input, Func<UserDetailsWithOrdersResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
		=> StreamResultResultSet1Async(interceptorProvider, null, connection, input, onRowAsync, cancellationToken);

	public static async Task StreamResultResultSet1Async(IXtraqProcedureInterceptorProvider? interceptorProvider, IXtraqParameterBindingProvider? bindingProvider, DbConnection connection, UserDetailsWithOrdersInput input, Func<UserDetailsWithOrdersResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		await ProcedureExecutor.StreamResultSetAsync(interceptorProvider, bindingProvider, connection, UserDetailsWithOrdersPlan.Instance, 0, StreamCoreAsync, input, cancellationToken).ConfigureAwait(false);
	}
	...
	public static Task StreamResultResultSet2Async(IXtraqProcedureInterceptorProvider? interceptorProvider, DbConnection connection, UserDetailsWithOrdersInput input, Func<UserDetailsWithOrdersResultSet2Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
		=> StreamResultResultSet2Async(interceptorProvider, null, connection, input, onRowAsync, cancellationToken);

	public static async Task StreamResultResultSet2Async(IXtraqProcedureInterceptorProvider? interceptorProvider, IXtraqParameterBindingProvider? bindingProvider, DbConnection connection, UserDetailsWithOrdersInput input, Func<UserDetailsWithOrdersResultSet2Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(connection);
		ArgumentNullException.ThrowIfNull(onRowAsync);
		...
		await ProcedureExecutor.StreamResultSetAsync(interceptorProvider, bindingProvider, connection, UserDetailsWithOrdersPlan.Instance, 1, StreamCoreAsync, input, cancellationToken).ConfigureAwait(false);
	}
