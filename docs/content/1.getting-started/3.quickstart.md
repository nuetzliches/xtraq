...
Make sure the xtraq CLI is available on your machine. Follow the [Installation guide](./2.installation.md) if you have not installed (or recently updated) the tool.
...
- Review tracked defaults and optional secrets in [Configuration Reference](../3.reference/configuration-schema.md).
