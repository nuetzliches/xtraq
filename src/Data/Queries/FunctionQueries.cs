...
ORDER BY s.name, o.name;";
        return context.ListAsync<FunctionRow>(
            sql,
            new List<SqlParameter>(),
            cancellationToken,
            telemetryOperation: "FunctionQueries.FunctionList",
            telemetryCategory: "Collector.Functions");
    }
 ...
 ORDER BY p.object_id, p.parameter_id;";
        return context.ListAsync<FunctionParamRow>(
            sql,
            new List<SqlParameter>(),
            cancellationToken,
            telemetryOperation: "FunctionQueries.FunctionParameters",
            telemetryCategory: "Collector.Functions");
    }
 ...
 ORDER BY c.object_id, c.column_id;";
        return context.ListAsync<FunctionColumnRow>(
            sql,
            new List<SqlParameter>(),
            cancellationToken,
            telemetryOperation: "FunctionQueries.FunctionColumns",
            telemetryCategory: "Collector.Functions");
    }
...
ORDER BY d.referencing_id, d.referenced_id;";
        return context.ListAsync<FunctionDependencyRow>(
            sql,
            new List<SqlParameter>(),
            cancellationToken,
            telemetryOperation: "FunctionQueries.FunctionDependencies",
            telemetryCategory: "Collector.Functions");
    }
}
