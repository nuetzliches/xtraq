...
public static class SyncUserContactsExtensions
{
	...
	public static async Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<SyncUserContactsResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
	...
	public static Task StreamResultResultSet1Async(this IXtraqDbContext db, Func<SyncUserContactsResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
...
public static class SyncUserContactsProcedure
{
	...
	public static async Task StreamResultResultSet1Async(DbConnection connection, Func<SyncUserContactsResultSet1Result, CancellationToken, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		...
		{
            int o0=ReaderUtil.TryGetOrdinal(r, "MergeAction");
            int o1=ReaderUtil.TryGetOrdinal(r, "ContactId");
            int o2=ReaderUtil.TryGetOrdinal(r, "UserId");
            int o3=ReaderUtil.TryGetOrdinal(r, "Email");
            int o4=ReaderUtil.TryGetOrdinal(r, "DisplayName");
            int o5=ReaderUtil.TryGetOrdinal(r, "Preferred");
            int o6=ReaderUtil.TryGetOrdinal(r, "LastInteractionUtc");
            int o7=ReaderUtil.TryGetOrdinal(r, "UpdatedAtUtc");
			while (await reader.ReadAsync(ct).ConfigureAwait(false))
			{
				var row = new SyncUserContactsResultSet1Result(o0 < 0 ? string.Empty : (r.IsDBNull(o0) ? string.Empty : r.GetString(o0)), o1 < 0 ? default(int) : r.GetInt32(o1), o2 < 0 ? default(int) : r.GetInt32(o2), o3 < 0 ? string.Empty : (r.IsDBNull(o3) ? string.Empty : r.GetString(o3)), o4 < 0 ? string.Empty : (r.IsDBNull(o4) ? string.Empty : r.GetString(o4)), o5 < 0 ? default(bool) : r.GetBoolean(o5), o6 < 0 ? null : (r.IsDBNull(o6) ? null : (DateTime?)r.GetDateTime(o6)), o7 < 0 ? null : (r.IsDBNull(o7) ? null : (DateTime?)r.GetDateTime(o7)));
	...
	public static Task StreamResultResultSet1Async(DbConnection connection, Func<SyncUserContactsResultSet1Result, ValueTask> onRowAsync, CancellationToken cancellationToken = default)
	{
		ArgumentNullException.ThrowIfNull(onRowAsync);
